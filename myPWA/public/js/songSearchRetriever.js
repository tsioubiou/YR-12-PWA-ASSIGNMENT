...
Object.keys(searchResults).forEach((key) => { // For every result in there.
    ...
    (searchResults[key].SongName).toString() + ", Length: " + 
    (searchResults[key].SongLength).toString() + ", Album: " + 
    (searchResults[key].AlbumName).toString();

    div.style.border = "2px solid white";
    div.style.borderRadius = "10px"; // Style the div to have border, margin, and padding.
